...
const loadStaff = async () => {
  await staffStore.getStaffById(staffId);
...
const updateStaff = handleSubmit( async (values) => {
  await staffStore.updateStaff(values, staffId);
            ...
            <div class="row g-3">
              ...
              <div class="col-12">
                <div class="button-group d-flex gap-2">
                  ...
                  <NuxtLink :to="{path: '/dashboard/staff'}" class="button-reverse">Cancel Edit</NuxtLink>
                </div>
              </div>
            </div>
          </form>
