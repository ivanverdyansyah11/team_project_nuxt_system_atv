...
const loadInstructor = async () => {
  await instructorStore.getInstructorById(instructorId);
  ...
  setValues({
    ...
    password: instructor.user.password,
  });
};

const updateInstructor = handleSubmit( async (values) => {
  await instructorStore.updateInstructor(values, instructorId);
            ...
            <div class="row g-3">
              ...
              <div class="col-12">
                <div class="button-group d-flex gap-2">
                  ...
                  <NuxtLink :to="{path: '/dashboard/instructor'}" class="button-reverse">Cancel Edit</NuxtLink>
                </div>
              </div>
            </div>
          </form>
