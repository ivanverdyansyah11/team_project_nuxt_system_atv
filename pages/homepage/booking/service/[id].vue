...
const schema = yup.object({
  ...
  entertainment_service_id: yup.string(),
...
const create = handleSubmit(async (values) => {
  ...
  values.entertainment_service_id = serviceStore.service.id
  values.details.push({
...
onMounted(async () => {
  ...
  totalPrice.value = serviceStore.service.price
  setValues({
    qty: 1,
    total_price: totalPrice.value,
  })
...
<template>
  <section class="hero-small container">
    <div class="row">
      <div class="col-12">
        <h2 class="title text-capitalize">Checkout Service</h2>
      </div>
        ...
        <div class="card-default">
          <form @submit.prevent="create" class="form w-100">
            <div class="row g-3">
              ...
              <div class="col-md-4">
                <div class="input-group d-flex flex-column">
                  <label for="entertainment_service_id" class="text-capitalize">Service</label>
                  <input type="text" class="input w-100" name="entertainment_service_id" id="entertainment_service_id" :value="serviceStore.service.name" readonly>
                </div>
              </div>
              <div class="col-md-4">
                <div class="input-group d-flex flex-column">
