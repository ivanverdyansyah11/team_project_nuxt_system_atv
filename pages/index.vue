    ...
    <div class="row align-items-center">
      ...
      <div class="offset-lg-1 col-lg-6">
        ...
        <div class="button-group d-flex gap-2 align-items-center">
          ...
          <a href="#whyChooseUs" class="button-reverse">Explore Our Attractions</a>
        </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="offset-lg-1 col-lg-6">
        ...
        <div class="button-group d-flex justify-content-between">
          <a target="_blank" href="https://whatsapp.com" class="button-primary-small">Contact Us</a>
          <div class="d-flex gap-1 align-items-center">
            <a target="_blank" href="https://instagram.com" class="button-sosmed">
              <i class="fa-brands fa-instagram"></i>
            </a>
            <a target="_blank" href="https://whatsapp.com" class="button-sosmed">
              <i class="fa-brands fa-whatsapp"></i>
            </a>
            <a target="_blank" href="https://facebook.com" class="button-sosmed">
